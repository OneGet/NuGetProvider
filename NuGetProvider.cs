    ...
    { 
        ...
        public void InitializeProvider(NuGetRequest request)
        {
            ...
            Features.AddOrSet("exe", new[] {
                // NuGet.exe is in the tools folder
                Path.Combine(Path.GetDirectoryName(location), "nuget-anycpu.exe")
            });
        }            
        ...
        public void GetDynamicOptions(string category, Request request)
        {
            ...
            switch ((category ?? string.Empty).ToLowerInvariant()) {
                ...
                case "package":
                    ...
                    request.YieldDynamicOption("SearchFilter", Constants.OptionType.StringArray, false);
        ...
        public void DownloadPackage(string fastPackageReference, string destLocation, NuGetRequest request)
        {
            ...
            try {
                ...
                if ((pkgItem.PackageSource == null) || (pkgItem.PackageSource.Location == null)
        ...
        public void InstallPackage(string fastPackageReference, NuGetRequest request) 
        {
            ...
            try {
                ...
                if (!NuGetClient.InstallPackageHelper(pkgItem, request))
                {
