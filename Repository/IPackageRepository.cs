namespace Microsoft.PackageManagement.NuGetProvider 
{
    ...
    public interface IPackageRepository
    {
        ...
        IPackage FindPackage(string packageId, SemanticVersion version, Request request); 

        /// <summary>
        /// Returns a sequence of packages with the specified id.
        /// </summary>
        IEnumerable<IPackage> FindPackagesById(string packageId, Request request);
        ...
        /// <returns></returns>
        IEnumerable<IPackage> Search(string searchTerm,  Request request);
    }
}